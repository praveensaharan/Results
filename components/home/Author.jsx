...
const Author = () => {
  return (
    <div className="w-full flex items-center justify-center bg-[#e3e2df] dark:bg-[#5d001e] px-4">
      <div className="relative w-full max-w-2xl my-8 md:my-16 flex flex-col items-center sm:items-start space-y-4 sm:space-y-0 sm:flex-row sm:space-x-6 px-4 py-8 border-2 border-dashed border-[#9a1750] dark:border-[#e3afbc] shadow-lg rounded-lg bg-white dark:bg-[#5d001e]">
