...
const Footer = () => {
  return (
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-[#5d001e]">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          <a
            ...
            aria-label="Go home"
            title="Company"
            className="inline-flex items-center bg-slate-50 p-2 rounded-xl"
          >
            <Image
              src="/finfind-high-resolution-logo-transparent (1).png"
              width={150}
              height={140}
              alt="logo"
            />
        ...
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            ...
            <a
              href="https://www.instagram.com/_praveen_saharan_"
              className="text-[#e3e2df] transition-colors duration-300 hover:text-[#9a1750]"
            >
            ...
            <a
              href="https://www.facebook.com/praveen.saharan.750/"
              className="text-[#e3e2df] transition-colors duration-300 hover:text-[#9a1750]"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-[#e3afbc] lg:flex-row">
        <p className="text-sm text-[#e3e2df]">
          © Copyright 2024 FinFind Inc. All rights reserved.
        </p>
